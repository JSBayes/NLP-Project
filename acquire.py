...
def get_links():
    ...
    input_urls = ["https://github.com/search?l=C%2B%2B&p=2&q=C%23&type=Repositories", "https://github.com/search?l=Python&o=desc&p=3&q=C%23&s=stars&type=Repositories", "https://github.com/search?l=HTML&o=desc&p=4&q=C%23&s=stars&type=Repositories"]
    urls = []
    for n in input_urls:
        url = n
